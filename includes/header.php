    ...
    <div class="container">
        <div class="row">
            <div class="top-content d-flex justify-content-between align-items-center">
                <div class="top-info-item d-flex align-items-center">
                    <div class="top-sec d-flex align-items-center">
                        <div class="address-sec">
                            <li>Near St.George Baslica Angamaly</li>
                        </div>
                        <i class="fa-solid fa-mobile-screen-button"></i>
                        <span>
                            <a href="tel:+91 97 8975 6343">+91 97 8975 6343</a>
                        </span>
                    </div>
                </div>
...
<!-- <div class="header-layout-4 header-bottom sticky-nav">
            ...
            <div class="header-main-4">
                <div class="header-left">
                    <div class="header-logo">
                        <a href="index.php">
                            <img src="assets/images/logo/ang.png" alt="logo not found" class="img-fluid">
                        </a>
                    </div>
                                ...
                                <div class="has-sub-menu has-mega-menu">
                                    ...
                                    <div class="ul-header-submenu ul-header-megamenu">
                                        <div class="single-col">
                                            <span class="single-col-title">Pages</span>
                                            <ul>
                                                <li><a href="blog.php">About</a></li>
                                                <li><a href="blog.html">Blogs</a></li>
                                                <li><a href="blog-2.html">Blogs one</a></li>
                                        ...
                                        <div class="single-col">
                                            <span class="single-col-title">Shop</span>
                                            <ul>
                ...
                <div class="right-side-part">
                    <div class="header-action-item">
                        <a href="#" class="header-action-btn cartmini-open-btn"><img src="assets/images/icons/user.png" alt="img" class="img-fluid icon-user">
                        </a>
                    </div>
                    <div class="toggle">
                        <span></span>
...
<div class="ul-sidebar">
    ...
    <div class="ul-sidebar-header">
        <div class="ul-sidebar-header-logo">
            <a href="index.html">
                <img src="assets/images/logo/my-ang-logo.png" alt="logo" class="logo">
            </a>
        </div>
        <!-- sidebar closer -->
    ...
    <div class="ul-sidebar-about d-none d-lg-block">
        ...
        <p class="gn-text mb-0">Phasellus eget fermentum maurisretra. Praesent varius eget justo ut lacinia. Phasellus pharetra velit.</p>
    </div>
                ...
                <div class="swiper-slide">
                    <div class="ul-product">
                        <div class="ul-product-img">
                            <img src="assets/images/blog/p3.webp" alt="Product Image">
                        </div>
    ...
    <div class="ul-sidebar-about d-none d-lg-block">
        <p class="gn-text mb-0">Phasellus eget fermentum maurinia consequa facilisis arcu arcu ultricies sapien. Quisque ut dapibus nunc. Vivamus sit amet efficitur velit. Phasellus eget fermentum mauris. Suspendisse nec dignissim nulla. Integer non quam commodo, scelerisque felis id, eleifend turpis. Phasellus in nulla quis erat tempor tristique eget vel pharetra velit.</p>
    </div>
...
<header class="ul-header sticky-nav">
    <!-- header bottom -->
